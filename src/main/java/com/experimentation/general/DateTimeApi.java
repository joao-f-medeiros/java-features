...
public class DateTimeApi {
  ...
  public static void main(String[] args) {
    ...
    LocalDateTime birthdayMoment = LocalDateTime.of(birthday, time);
    System.out.println(birthdayMoment);
    ...
    Instant i = Instant.ofEpochMilli(500000000000000L);
    ...
    ZonedDateTime zdt = ZonedDateTime.of(birthdayMoment, zone);
